...
![inline start attachment](https://github.com/vmpstr/htmldemos/blob/master/gestures/resources/inline-start-attachment.png)
...
![e and target content](https://github.com/vmpstr/htmldemos/blob/master/gestures/resources/e-and-target-content.png)

Then we can do a swipe to reveal _e_:

![e pushes content](https://github.com/vmpstr/htmldemos/blob/master/gestures/resources/e-pushes-content.png)
...
![e overlays content](https://github.com/vmpstr/htmldemos/blob/master/gestures/resources/e-overlays-content.png)
...
![two attachments](https://github.com/vmpstr/htmldemos/blob/master/gestures/resources/two-attachments.png)

Now consider what happens when we complete the gesture.

Option 1: everything moves in sync as far as the widest element:

![two attachments together](https://github.com/vmpstr/htmldemos/blob/master/gestures/resources/two-attachments-together.png)

Option 2: the smaller element sticks to the edge when it would scroll too far:

![two attachments sticky](https://github.com/vmpstr/htmldemos/blob/master/gestures/resources/two-attachments-sticky.png)
